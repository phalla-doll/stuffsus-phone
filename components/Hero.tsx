...
export default function Hero() {
  return (
    <section className="px-4 md:px-8 mb-16 md:mb-24">
      <div className="relative w-full h-[300px] sm:h-[350px] md:h-[450px] rounded-2xl md:rounded-3xl overflow-hidden flex items-center justify-center">
        {/* Background Image */}
        <Image 
        ...
        {/* Search Bar Overlay */}
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-6 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
          <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-white max-w-xs leading-tight drop-shadow-md">
            Give All You Need
          </h2>
